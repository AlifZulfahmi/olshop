                        ...
                        <div class="profile-picture">
                            <div class="avatar avatar-xl">
                                @if ($user->profile_image)
                                    <img src="{{ asset('storage/images/' . $user->profile_image) }}" alt="Profile Picture"
                    ...
                    <div class="card-body">
                        <div class="user-profile">
                            ...
                            <div class="view-profile mt-3">
                                <a href="/home" class="btn btn-secondary w-100">Back</a>
                            </div>
                            <!-- Tambahkan tombol Edit -->
                            <div class="edit-profile mt-2">
                                <a href="{{ route('profile_edit') }}" class="btn btn-primary w-100">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
