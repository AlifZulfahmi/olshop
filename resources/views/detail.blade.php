        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
                    <img class="w-full h-full object-cover mx-auto rounded-md" src="{{ asset('images/' . $product->image) }}"
                        alt="{{ $product->name }}" />
                </div>
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <div class="mt-4 sm:items-center sm:gap-4 sm:flex">
                        ...
                        <span
                            class="me-2 rounded bg-primary-100 px-3 py-2 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="w-full h-full object-cover mx-auto rounded-md"
                                src="{{ asset('images/' . $randomProduct->image) }}" alt="{{ $randomProduct->name }}" />
                        </a>
                    </div>
                    <div class="pt-6">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            <span
                                class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">{{ $randomProduct->category->name }}</span>
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $randomProduct->name }}</a>
